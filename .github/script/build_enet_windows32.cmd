...
cmake -DCMAKE_BUILD_TYPE=Release -DENET_NO_STATIC_BINARY=ON -DWITH_DHT=OFF -DBUILD_WITH_FS=ON -DWITH_ZIP=OFF -DENET_VERSION=lts_1.3  -G"Visual Studio 17 2022" -Tv143 -AWin32 ..
echo ================end-1======================
...
cmake .. -DCOMPILE_SYSTEM=windows -DSYSTEM_ARCH=x86 -DCOMPILE_TYPE=Release -DCMAKE_BUILD_TYPE=Release  -G"Visual Studio 17 2022" -Tv143 -AWin32 ..
cmake --build . --config Release
